...
- `fig/` the figure PDFs: the result plots and the reconstruction panel
  ...
  `data/masks.csv`, `data/prefix_eval.csv`, and `data/visual/`;
...
| `checkpoints_psma_pow2_20260904/swinsc_ov_u{4,8}_psma` (powers of two) | same flags without `--all_prefix` (term over b in {1,2,4,8}); drawn in Fig. 6 as "PSMA, powers of two" from `data/prefix_eval.csv` model `psma_pow2` |
